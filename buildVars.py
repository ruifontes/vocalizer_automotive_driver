...
addon_info = {
	...
	"addon_name": "vocalizer_automotive_driver",
	...
	"addon_url": "https://www.tiflotecnia.net/en/index.htm",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/ruifontes/vocalizer_automotive_driver",
